...
public class EnglishLetterGame extends AbstractGame {
    private static final Logger logger = LogManager.getLogger(EnglishLetterGame.class);
    ...
    public void start(Integer sizeWord, Integer tryCount) {
        ...
        logger.info("Starting English game with secret word: {}", secretWord);
    }

    @Override
    String generateSecretWord(Integer sizeWord) {
        StringBuilder sb = new StringBuilder();
        // Генерация случайного слова из английских букв
